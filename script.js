...
$form.addEventListener("submit", function(event) {
 ...
 const $copilotValue = document.querySelector("input[name=copilotName]").value 
 const $fuelLevelValue = document.querySelector("input[name=fuelLevel]").value 
 const $cargoMassValue= document.querySelector("input[name0=cargoMass]").value    
